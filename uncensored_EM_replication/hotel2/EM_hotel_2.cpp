// EM implemented for Hotel 2 dataset
#include <iostream>
#include <iomanip>
#include <algorithm>
#include <iterator>
...
{
	io::CSVReader<13> in(avail_filename);
...
int main()
{
	...
	int **sigma_matrix = import_prefs("../data/hotel_2/PrefListsBuyUpH2.csv");
	int **avail_matrix = import_availability("../data/hotel_2/AvailabilityH2.csv");
	int *trans_vec = import_transactions("../data/hotel_2/TransactionsH2.csv");
