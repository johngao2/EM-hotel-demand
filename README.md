## Project Overview:
~~Step 1: Implement simple multinomial logit go get familiar with likelihood maximization using CppAD and IPOPT packages.~~ **- Done**  *(MNL_baseline > simple_mnl > simple_mnl.cpp)*
