// EM implemented for Hotel 1 dataset
#include <iostream>
#include <iomanip>
#include <algorithm>
#include <iterator>
...
#define n_times 1315 // number of time steps
#define n_options 10 // number of products
...
int **import_prefs(const char *pref_filename)
{
	...
	io::CSVReader<12> in(pref_filename);
...
{
	io::CSVReader<11> in(avail_filename);
...
int main()
{
	...
	int **sigma_matrix = import_prefs("../data/hotel_1/PrefListsBuyUpH1.csv");
	int **avail_matrix = import_availability("../data/hotel_1/AvailabilityH1.csv");
	int *trans_vec = import_transactions("../data/hotel_1/TransactionsH1.csv");
