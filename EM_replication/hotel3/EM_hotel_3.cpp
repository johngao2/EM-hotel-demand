// EM implemented for Hotel 3 dataset
#include <iostream>
#include <iomanip>
#include <algorithm>
#include <iterator>
...
#define n_times 1147 // number of time steps
...
int main()
{
	...
	int **sigma_matrix = import_prefs("../data/hotel_3/PrefListsBuyUpH3.csv");
	int **avail_matrix = import_availability("../data/hotel_3/AvailabilityH3.csv");
	int *trans_vec = import_transactions("../data/hotel_3/TransactionsH3.csv");
